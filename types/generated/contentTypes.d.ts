...
export interface ApiFirstBlockContentFirstBlockContent
  extends Schema.SingleType {
  collectionName: 'first_block_contents';
  info: {
    singularName: 'first-block-content';
    pluralName: 'first-block-contents';
    displayName: 'First block content';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    activities: Attribute.Text & Attribute.Required;
    background: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::first-block-content.first-block-content',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNewspaperNewspaper extends Schema.CollectionType {
  ...
  attributes: {
    ...
    views: Attribute.BigInteger & Attribute.Required & Attribute.DefaultTo<'0'>;
    text: Attribute.Blocks & Attribute.Required;
    cover: Attribute.Media;
    cover_description: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSurveySurvey extends Schema.CollectionType {
  ...
  attributes: {
    description: Attribute.Blocks & Attribute.Required;
    yes_no_options: Attribute.Boolean &
      Attribute.Required &
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::first-block-content.first-block-content': ApiFirstBlockContentFirstBlockContent;
